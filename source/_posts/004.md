...
本文的主要操作在 Sob 老师[《通过 Multiwfn 绘制等化学屏蔽表面(ICSS)研究芳香性](http://sobereva.com/216)一文中有详细的介绍，本文主要介绍我自己的计算、绘制习惯。本文所有计算都是在 Fedora Linux 下完成的。
...
surface_6 := IsoSurface{-0.6, 18}
surface_6 := IsoSurface{-1.0, 12}
surface_6 := IsoSurface{-1.5, 21}
surface_6 := IsoSurface{-2.5, 24}
```
